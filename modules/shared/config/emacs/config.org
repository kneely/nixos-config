...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Kevin Neely"
    user-mail-address "kevin.r.neely@outlook.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/kevin/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/kevin/bin" "/profile/bin" "/Users/kevin/.npm-packages/bin" "/Users/kevin/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
